...
<?php
/*
 * reboot.php - VM rebooter for Xen VNC Proxy PHP Pages
 *
...
function main()
{
    global $poolname, $vmname, $jsvmname, $rebooted;
    ...
    if (!xvp_db_user_may_perform($vm, null, "reboot"))
	return;

    if (xenapi_vm_restart($session, $ref)) {
	$rebooted = "true";
    }
}
...
<head>
<title>xvp VM Reboot</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<meta http-equiv="Imagetoolbar" content="no" />
<meta http-equiv="pragma" content="no-cache" />
<meta http-equiv="Cache-Control" content="no-cache" />
<meta name="description" content="xvp VM Reboot" />
<meta name="copyright" content="(C) Colin Dean" />
<meta name="author" content="Colin Dean" />
<meta name="robots" content="noindex,nofollow,noarchive" />
<link rel="stylesheet" type="text/css" href="css/styles.css" />
</head>
<body onload="window.parent.actionCallback('$fullname', '$jsvmname', 'reboot', '$rebooted');">
</body>
</html>
EOF;
