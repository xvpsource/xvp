...
<?php
/*
 * suspend.php - VM suspender for Xen VNC Proxy PHP Pages
 *
...
function main()
{
    global $poolname, $vmname, $jsvmname, $suspended;
    ...
    if (!xvp_db_user_may_perform($vm, null, "suspend"))
	return;

    $always = xenapi_vm_get_ha_always_run($session, $ref);
    if ($always === true) {
	// disable HA prior to suspend
	xenapi_vm_set_ha_always_run($session, $ref, false);
    }

    if (xenapi_vm_suspend($session, $ref)) {
	$suspended = "true";
    } else if ($always === true) {
...
<head>
<title>xvp VM Suspend</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<meta http-equiv="Imagetoolbar" content="no" />
<meta http-equiv="pragma" content="no-cache" />
<meta http-equiv="Cache-Control" content="no-cache" />
<meta name="description" content="xvp VM Suspend" />
<meta name="copyright" content="(C) Colin Dean" />
<meta name="author" content="Colin Dean" />
<meta name="robots" content="noindex,nofollow,noarchive" />
<link rel="stylesheet" type="text/css" href="css/styles.css" />
</head>
<body onload="window.parent.actionCallback('$fullname', '$jsvmname', 'suspend', '$suspended');">
</body>
</html>
EOF;
