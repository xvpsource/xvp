...
//
// Modification to use Send button instead of losing focus to send cut
// text to server Copyright (C) 2012 Colin Dean. 
//
...
class ClipboardFrame extends Frame
  ...
  TextArea textArea;
  Button clearButton, closeButton, sendButton;
  String selection;
  VncViewer viewer;
  ...
  ClipboardFrame(VncViewer v) {
    ...
    gridbag.setConstraints(sendButton, gbc);
    add(sendButton);
